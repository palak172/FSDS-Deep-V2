...
class SafetySystem:
    ...
    def run(self):
        ...
        print("   2. Press ENTER")
        print("   3. Type Batch ID (e.g., 001, 002)")
        print("   4. Press ENTER again")
        print("   5. System will auto-create batch if it doesn't exist")
        print("   6. Safety monitoring will begin\n")
        ...
        try:
            while self.is_running:
                ...
                # Handle input before safety processing
                if not self.monitor.session_active:
                    ...
                    # Handle input keys (numbers only for simplicity)
                    if 48 <= key <= 57 or 65 <= key <=90 or 97 <= key <= 122:  # Number keys
                        ...
                        if self.input_overlay.is_confirmed():
                            ...
                            # SIMPLE: Just call start_work_session - it handles everything
                            # (checks batch existence, creates if needed, starts session)
